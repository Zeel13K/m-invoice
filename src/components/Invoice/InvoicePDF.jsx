...
import NewQrCode from '/src/assets/new qr.jpeg';
      ...
      <div className="pdf-container" ref={pdfRef}>
        ...
        <div style={{ display: 'flex', margin: '10px' }}>
          <div style={{ flex: 2 }}>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
              <label style={{ width: '80px', fontWeight: 'bold', fontSize: '19px', fontFamily: "'Poppins', sans-serif" }}>M/s.</label>
              <span style={{ flex: 1, padding: '5px', fontWeight: 'bold', fontSize: '24px', fontFamily: "'Crimson Text', serif" }}>{formData.ms}</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <label style={{ width: '80px', fontWeight: 'bold', fontSize: '19px', fontFamily: "'Poppins', sans-serif" }}>Mo No.</label>
              <span style={{ flex: 1, padding: '5px', fontWeight: 'bold', fontSize: '22px', fontFamily: "'Crimson Text', serif" }}>{formData.mobileNo}</span>
            </div>
          </div>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
              <label style={{ width: '80px', fontWeight: 'bold', fontSize: '19px', fontFamily: "'Poppins', sans-serif" }}>Bill No</label>
              <span style={{ flex: 1, padding: '5px', fontWeight: 'bold', fontSize: '22px', fontFamily: "'Crimson Text', serif" }}>{formData.billNo}</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <label style={{ width: '80px', fontWeight: 'bold', fontSize: '19px', fontFamily: "'Poppins', sans-serif" }}>Date.</label>
              <span style={{ flex: 1, padding: '5px', fontWeight: 'bold', fontSize: '22px', fontFamily: "'Crimson Text', serif" }}>
        ...
        <div className="invoice-items">
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ flex: '0.5', textAlign: 'center', padding: '8px', fontWeight: 'normal', fontSize: '18px' }}></div>
            <div style={{ flex: '0.5', textAlign: 'center', padding: '8px', fontWeight: 'normal', fontSize: '18px' }}></div>
            <div style={{ flex: '0.8', textAlign: 'center', padding: '8px', borderLeft: '3px solid #000080', fontWeight: 'bold', fontSize: '28px', fontFamily: 'Arial, sans-serif', borderBottom: '2px solid #000080' }}>
              {Math.floor(formData.items.reduce((sum, item) => sum + (parseFloat(item.amount) || 0), 0))}/-
            </div>
          </div>
        </div>
